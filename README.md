...
Please note that the Xiaomi Home integration in this repository is `a non-officially maintained version`, which is a fork based on `v0.1.5`. This version will implement more and more advanced geek features.
